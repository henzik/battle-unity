...
bool Reflect_obj::hasField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","hasField",0xef8c2571,"Reflect.hasField","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",24,0x077956a9)
	HX_STACK_ARG(o,"o")
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","field",0x54b04da9,"Reflect.field","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",28,0x077956a9)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(29)
	bool tmp = (o == null());		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("Reflect","setField",0x71684429,"Reflect.setField","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",32,0x077956a9)
		HX_STACK_ARG(o,"o")
		HX_STACK_ARG(field,"field")
...
Dynamic Reflect_obj::getProperty( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","getProperty",0x632ca13a,"Reflect.getProperty","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",37,0x077956a9)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(38)
	bool tmp = (o == null());		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("Reflect","setProperty",0x6d99a846,"Reflect.setProperty","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",41,0x077956a9)
		HX_STACK_ARG(o,"o")
		HX_STACK_ARG(field,"field")
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(42)
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,cpp::ArrayBase args){
	HX_STACK_FRAME("Reflect","callMethod",0xb49e52d0,"Reflect.callMethod","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",46,0x077956a9)
	HX_STACK_ARG(o,"o")
...
Array< ::String > Reflect_obj::fields( Dynamic o){
	HX_STACK_FRAME("Reflect","fields",0xc593a6aa,"Reflect.fields","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",53,0x077956a9)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(54)
	bool tmp = (o == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(54)
...
bool Reflect_obj::isFunction( Dynamic f){
	HX_STACK_FRAME("Reflect","isFunction",0x0f1541d3,"Reflect.isFunction","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",60,0x077956a9)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(61)
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	HX_STACK_FRAME("Reflect","compareMethods",0x8b8ddd7e,"Reflect.compareMethods","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",68,0x077956a9)
	HX_STACK_ARG(f1,"f1")
	HX_STACK_ARG(f2,"f2")
	HX_STACK_LINE(69)
...
bool Reflect_obj::isObject( Dynamic v){
	HX_STACK_FRAME("Reflect","isObject",0xd04960ba,"Reflect.isObject","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",76,0x077956a9)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(77)
...
bool Reflect_obj::deleteField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","deleteField",0x21895ebe,"Reflect.deleteField","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",87,0x077956a9)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(88)
	bool tmp = (o == null());		HX_STACK_VAR(tmp,"tmp");
...
Dynamic Reflect_obj::makeVarArgs( Dynamic f){
	HX_STACK_FRAME("Reflect","makeVarArgs",0x978955c5,"Reflect.makeVarArgs","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",104,0x077956a9)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(105)
