...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(310)
		{
			...
			HX_STACK_LINE(310)
			tmp16->__Field(HX_HCSTRING("gameReset","\x7d","\x38","\xe3","\x1b"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
			HX_STACK_LINE(310)
		...
		HX_STACK_LINE(313)
		int tmp17 = tmp16->_stepMS;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(313)
		Float tmp18 = (Float((int)1000) / Float(tmp17));		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(313)
		int tmp19 = ::Std_obj::_int(tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(313)
		int tmp20 = ::flixel::FlxG_obj::drawFramerate;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(313)
		...
		HX_STACK_LINE(319)
		::String tmp23 = ::openfl::_legacy::events::Event_obj::ENTER_FRAME;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(319)
		Dynamic tmp24 = this->onEnterFrame_dyn();		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(319)
		...
		HX_STACK_LINE(323)
		::String tmp26 = ::openfl::_legacy::events::Event_obj::RESIZE;		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(323)
		Dynamic tmp27 = this->onResize_dyn();		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(323)
		...
		HX_STACK_LINE(326)
		int tmp33 = tmp32->get_stageHeight();		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(326)
		this->resizeGame(tmp30,tmp33);
	}
return null();
}
...
Void FlxGame_obj::onFocus( Dynamic _){
{
		...
		HX_STACK_LINE(367)
		::openfl::_legacy::display::Stage tmp3 = this->get_stage();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(367)
		int tmp4 = ::flixel::FlxG_obj::drawFramerate;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(367)
		tmp3->set_frameRate(tmp4);
		HX_STACK_LINE(369)
		::flixel::_system::frontEnds::SoundFrontEnd tmp5 = ::flixel::FlxG_obj::sound;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(369)
		tmp5->__Field(HX_HCSTRING("onFocus","\x39","\xfe","\xc6","\x9a"), hx::paccDynamic )();
		HX_STACK_LINE(371)
		{
			HX_STACK_LINE(371)
			...
			HX_STACK_LINE(371)
			Array< ::flixel::interfaces::IFlxInput > _g1 = tmp6->__Field(HX_HCSTRING("list","\x5e","\x1c","\xb3","\x47"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(371)
			while((true)){
				HX_STACK_LINE(371)
				...
				HX_STACK_LINE(371)
				::flixel::interfaces::IFlxInput tmp9 = _g1->__get(_g);		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(371)
				::flixel::interfaces::IFlxInput input = tmp9;		HX_STACK_VAR(input,"input");
				HX_STACK_LINE(371)
				++(_g);
				HX_STACK_LINE(371)
				input->onFocus();
...
Void FlxGame_obj::onFocusLost( Dynamic _){
{
		...
		::openfl::_legacy::display::Stage tmp3 = this->get_stage();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(403)
		int tmp4 = this->focusLostFramerate;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(403)
		tmp3->set_frameRate(tmp4);
		HX_STACK_LINE(405)
		::flixel::_system::frontEnds::SoundFrontEnd tmp5 = ::flixel::FlxG_obj::sound;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(405)
		tmp5->__Field(HX_HCSTRING("onFocusLost","\xbd","\xe4","\x85","\x41"), hx::paccDynamic )();
		HX_STACK_LINE(407)
		{
			HX_STACK_LINE(407)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
Void FlxGame_obj::resizeGame( int width,int height){
{
		...
		HX_STACK_LINE(443)
		::flixel::_system::ui::FlxSoundTray tmp = this->soundTray;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(443)
		bool tmp1 = (tmp != null());		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(443)
		if ((tmp1)){
			...
			HX_STACK_LINE(445)
			tmp2->__Field(HX_HCSTRING("screenCenter","\x61","\x2e","\xf9","\xe2"), hx::paccDynamic )();
		}
		HX_STACK_LINE(449)
		::openfl::_legacy::display::Sprite tmp2 = this->_inputContainer;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(449)
		::flixel::FlxGame tmp3 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(449)
		Float tmp4 = tmp3->get_scaleX();		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(449)
		Float tmp5 = (Float((int)1) / Float(tmp4));		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(449)
		tmp2->set_scaleX(tmp5);
		HX_STACK_LINE(450)
		::openfl::_legacy::display::Sprite tmp6 = this->_inputContainer;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(450)
		::flixel::FlxGame tmp7 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(450)
		Float tmp8 = tmp7->get_scaleY();		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(450)
		Float tmp9 = (Float((int)1) / Float(tmp8));		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(450)
		tmp6->set_scaleY(tmp9);
	}
return null();
}
