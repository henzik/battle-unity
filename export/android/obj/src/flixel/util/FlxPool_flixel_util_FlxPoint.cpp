...
Void FlxPool_flixel_util_FlxPoint_obj::__construct(::hx::Class classObj)
{
...
hx::ObjectPtr< FlxPool_flixel_util_FlxPoint_obj > FlxPool_flixel_util_FlxPoint_obj::__new(::hx::Class classObj)
{  hx::ObjectPtr< FlxPool_flixel_util_FlxPoint_obj > _result_ = new FlxPool_flixel_util_FlxPoint_obj();
...
::flixel::util::FlxPoint FlxPool_flixel_util_FlxPoint_obj::get( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(25)
	::flixel::util::FlxPoint tmp = this->_pool->pop().StaticCast< ::flixel::util::FlxPoint >();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(25)
	::flixel::util::FlxPoint obj = tmp;		HX_STACK_VAR(obj,"obj");
	HX_STACK_LINE(26)
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(28)
		::flixel::util::FlxPoint tmp3 = ::Type_obj::createInstance(tmp2,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(28)
		obj = tmp3;
	}
	HX_STACK_LINE(30)
	::flixel::util::FlxPoint tmp2 = obj;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(30)
	return tmp2;
}
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_FlxPoint","put",0xced67864,"flixel.util.FlxPool_flixel_util_FlxPoint.put","flixel/util/FlxPool.hx",34,0xdd4de86a)
		HX_STACK_THIS(this)
		...
		if ((tmp)){
			...
			::flixel::util::FlxPoint tmp2 = obj;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(36)
			::flixel::util::FlxPoint tmp3 = tmp2;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(36)
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_FlxPoint","putUnsafe",0x8019d3aa,"flixel.util.FlxPool_flixel_util_FlxPoint.putUnsafe","flixel/util/FlxPool.hx",44,0xdd4de86a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(45)
		bool tmp = (obj != null());		HX_STACK_VAR(tmp,"tmp");
		...
		if ((tmp)){
			...
			obj->destroy();
			HX_STACK_LINE(48)
			::flixel::util::FlxPoint tmp1 = obj;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(48)
...
Void FlxPool_flixel_util_FlxPoint_obj::preAllocate( int numObjects){
{
		...
		while((true)){
			...
			HX_STACK_LINE(56)
			::flixel::util::FlxPoint tmp4 = ::Type_obj::createInstance(tmp3,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(56)
...
int FlxPool_flixel_util_FlxPoint_obj::get_length( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_FlxPoint","get_length",0x70e6fbba,"flixel.util.FlxPool_flixel_util_FlxPoint.get_length","flixel/util/FlxPool.hx",68,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(69)
...
Dynamic FlxPool_flixel_util_FlxPoint_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic FlxPool_flixel_util_FlxPoint_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
...
bool FlxPool_flixel_util_FlxPoint_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(FlxPool_flixel_util_FlxPoint_obj,_pool),HX_HCSTRING("_pool","\xbb","\x9c","\x6d","\xfd")},
	{hx::fsObject /*::hx::Class*/ ,(int)offsetof(FlxPool_flixel_util_FlxPoint_obj,_class),HX_HCSTRING("_class","\x79","\xbf","\x3f","\x44")},
	{ hx::fsUnknown, 0, null()}
};
...
hx::Class FlxPool_flixel_util_FlxPoint_obj::__mClass;

void FlxPool_flixel_util_FlxPoint_obj::__register()
{
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("flixel.util.FlxPool_flixel_util_FlxPoint","\x83","\xc7","\xab","\xd3");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &FlxPool_flixel_util_FlxPoint_obj::__SetStatic;
	__mClass->mMarkFunc = sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(sMemberFields);
	__mClass->mCanCast = hx::TCanCast< FlxPool_flixel_util_FlxPoint_obj >;
#ifdef HXCPP_VISIT_ALLOCS
