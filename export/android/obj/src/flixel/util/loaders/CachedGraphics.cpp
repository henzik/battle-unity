...
{
		HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","undump",0x016856e6,"flixel.util.loaders.CachedGraphics.undump","flixel/util/loaders/CachedGraphics.hx",87,0x7a61d3e8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(89)
...
{
		HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","onContext",0x22400957,"flixel.util.loaders.CachedGraphics.onContext","flixel/util/loaders/CachedGraphics.hx",113,0x7a61d3e8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(115)
		bool tmp = this->isDumped;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(115)
...
bool CachedGraphics_obj::get_canBeDumped( ){
	HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","get_canBeDumped",0x64ad8a84,"flixel.util.loaders.CachedGraphics.get_canBeDumped","flixel/util/loaders/CachedGraphics.hx",179,0x7a61d3e8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(180)
	::hx::Class tmp = this->assetsClass;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(180)
