...
::flixel::util::LabelValuePair FlxPool_flixel_util_LabelValuePair_obj::get( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(25)
	::flixel::util::LabelValuePair tmp = this->_pool->pop().StaticCast< ::flixel::util::LabelValuePair >();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(25)
	::flixel::util::LabelValuePair obj = tmp;		HX_STACK_VAR(obj,"obj");
	HX_STACK_LINE(26)
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","put",0x9e8d6fbd,"flixel.util.FlxPool_flixel_util_LabelValuePair.put","flixel/util/FlxPool.hx",34,0xdd4de86a)
		HX_STACK_THIS(this)
		...
		if ((tmp)){
			...
			::flixel::util::LabelValuePair tmp2 = obj;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(36)
			::flixel::util::LabelValuePair tmp3 = tmp2;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(36)
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","putUnsafe",0xa6da53c3,"flixel.util.FlxPool_flixel_util_LabelValuePair.putUnsafe","flixel/util/FlxPool.hx",44,0xdd4de86a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(45)
		bool tmp = (obj != null());		HX_STACK_VAR(tmp,"tmp");
...
Void FlxPool_flixel_util_LabelValuePair_obj::preAllocate( int numObjects){
{
		...
		while((true)){
			...
			HX_STACK_LINE(56)
			::flixel::util::LabelValuePair tmp4 = ::Type_obj::createInstance(tmp3,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(56)
...
int FlxPool_flixel_util_LabelValuePair_obj::get_length( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","get_length",0x32969181,"flixel.util.FlxPool_flixel_util_LabelValuePair.get_length","flixel/util/FlxPool.hx",68,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(69)
...
bool FlxPool_flixel_util_LabelValuePair_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void FlxPool_flixel_util_LabelValuePair_obj::__register()
{
	...
	__mClass->mSetStaticField = &FlxPool_flixel_util_LabelValuePair_obj::__SetStatic;
