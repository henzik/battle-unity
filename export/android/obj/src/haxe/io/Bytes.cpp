...
{
HX_STACK_FRAME("haxe.io.Bytes","new",0x3938d57d,"haxe.io.Bytes.new","E:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",33,0x4fb6f94a)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","E:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",79,0x4fb6f94a)
		HX_STACK_THIS(this)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","E:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",133,0x4fb6f94a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(135)
...
::String Bytes_obj::getString( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","E:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",357,0x4fb6f94a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(359)
...
::String Bytes_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","E:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",416,0x4fb6f94a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(433)
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_FRAME("haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","E:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",455,0x4fb6f94a)
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(465)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_FRAME("haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","E:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",482,0x4fb6f94a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(493)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(494)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_FRAME("haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","E:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",540,0x4fb6f94a)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(550)
