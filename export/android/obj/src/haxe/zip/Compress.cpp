...
{
HX_STACK_FRAME("haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",29,0xfe53cf8d)
HX_STACK_THIS(this)
...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",33,0xfe53cf8d)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",37,0xfe53cf8d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(38)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",41,0xfe53cf8d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(42)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(42)
...
::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,int level){
	HX_STACK_FRAME("haxe.zip.Compress","run",0x4ddf6794,"haxe.zip.Compress.run","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",45,0xfe53cf8d)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(level,"level")
	HX_STACK_LINE(46)
