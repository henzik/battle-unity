...
{
HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",51,0x034eee60)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",54,0x034eee60)
		HX_STACK_THIS(this)
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",57,0x034eee60)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(58)
...
bool ObjectMap_obj::exists( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","exists",0xc8930ca4,"haxe.ds.ObjectMap.exists","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",61,0x034eee60)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(62)
...
bool ObjectMap_obj::remove( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","remove",0x0d3b8b0c,"haxe.ds.ObjectMap.remove","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",65,0x034eee60)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(66)
...
Dynamic ObjectMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",69,0x034eee60)
	HX_STACK_THIS(this)
	HX_STACK_LINE(70)
...
Dynamic ObjectMap_obj::iterator( ){
	HX_STACK_FRAME("haxe.ds.ObjectMap","iterator",0x61fc7ab6,"haxe.ds.ObjectMap.iterator","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",74,0x034eee60)
	HX_STACK_THIS(this)
	HX_STACK_LINE(75)
