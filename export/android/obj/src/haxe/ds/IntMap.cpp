...
{
HX_STACK_FRAME("haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",52,0x920cf5f2)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",55,0x920cf5f2)
		HX_STACK_THIS(this)
...
Dynamic IntMap_obj::get( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",58,0x920cf5f2)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(59)
...
bool IntMap_obj::exists( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",62,0x920cf5f2)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(63)
...
bool IntMap_obj::remove( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","remove",0xa86281ae,"haxe.ds.IntMap.remove","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",66,0x920cf5f2)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(67)
...
Dynamic IntMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.IntMap","keys",0x6a4db8de,"haxe.ds.IntMap.keys","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",70,0x920cf5f2)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
...
Dynamic IntMap_obj::iterator( ){
	HX_STACK_FRAME("haxe.ds.IntMap","iterator",0x4dc7ddd8,"haxe.ds.IntMap.iterator","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",75,0x920cf5f2)
	HX_STACK_THIS(this)
	HX_STACK_LINE(76)
