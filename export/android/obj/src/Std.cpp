...
bool Std_obj::is( Dynamic v,Dynamic t){
	HX_STACK_FRAME("Std","is",0x3c56d6f5,"Std.is","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",23,0xe0f8d203)
	HX_STACK_ARG(v,"v")
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(24)
...
Dynamic Std_obj::instance( Dynamic value,::hx::Class c){
	HX_STACK_FRAME("Std","instance",0x1431f4e0,"Std.instance","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",27,0xe0f8d203)
...
::String Std_obj::string( Dynamic s){
	HX_STACK_FRAME("Std","string",0xcf48855c,"Std.string","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",31,0xe0f8d203)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(32)
...
int Std_obj::_int( Float x){
	HX_STACK_FRAME("Std","int",0x8fa53b84,"Std.int","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",35,0xe0f8d203)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(36)
...
Dynamic Std_obj::parseInt( ::String x){
	HX_STACK_FRAME("Std","parseInt",0x90c2ebc7,"Std.parseInt","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",39,0xe0f8d203)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(40)
...
Float Std_obj::parseFloat( ::String x){
	HX_STACK_FRAME("Std","parseFloat",0xbca10a74,"Std.parseFloat","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",43,0xe0f8d203)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(44)
...
int Std_obj::random( int x){
	HX_STACK_FRAME("Std","random",0x75a77e8e,"Std.random","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",47,0xe0f8d203)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(48)
