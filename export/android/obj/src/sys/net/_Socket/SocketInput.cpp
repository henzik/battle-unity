...
{
HX_STACK_FRAME("sys.net._Socket.SocketInput","new",0x5fe92abb,"sys.net._Socket.SocketInput.new","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",31,0xd53586af)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
{
	HX_STACK_LINE(31)
...
int SocketInput_obj::readByte( ){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readByte",0xee593543,"sys.net._Socket.SocketInput.readByte","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",34,0xd53586af)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketInput","close",0xbbc7fed3,"sys.net._Socket.SocketInput.close","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",64,0xd53586af)
		HX_STACK_THIS(this)
		HX_STACK_LINE(65)
		this->super::close();
		HX_STACK_LINE(66)
