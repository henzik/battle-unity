...
{
HX_STACK_FRAME("states.MenuState","new",0xfb0d7598,"states.MenuState.new","MenuState.hx",11,0xdfbcb22c)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("states.MenuState","create",0x702ed4c4,"states.MenuState.create","MenuState.hx",22,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(24)
