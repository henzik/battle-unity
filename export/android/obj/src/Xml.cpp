...
::String Xml_obj::get( ::String att){
	HX_STACK_FRAME("Xml","get",0x2e441e5f,"Xml.get","E:\\HaxeToolkit\\haxe\\std/Xml.hx",166,0x145d10be)
	HX_STACK_THIS(this)
...
Dynamic Xml_obj::elements( ){
	HX_STACK_FRAME("Xml","elements",0x0310ffce,"Xml.elements","E:\\HaxeToolkit\\haxe\\std/Xml.hx",229,0x145d10be)
	HX_STACK_THIS(this)
	HX_STACK_LINE(230)
	{
		HX_STACK_LINE(230)
