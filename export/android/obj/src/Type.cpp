...
::hx::Class Type_obj::getClass( Dynamic o){
	HX_STACK_FRAME("Type","getClass",0xc4e49bd6,"Type.getClass","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",35,0x2f1ad73c)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(36)
...
::hx::Class Type_obj::getSuperClass( ::hx::Class c){
	HX_STACK_FRAME("Type","getSuperClass",0xd9ffa85f,"Type.getSuperClass","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",52,0x2f1ad73c)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(53)
...
::String Type_obj::getClassName( ::hx::Class c){
	HX_STACK_FRAME("Type","getClassName",0x8e66dd41,"Type.getClassName","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",56,0x2f1ad73c)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(57)
...
::String Type_obj::getEnumName( ::Enum e){
	HX_STACK_FRAME("Type","getEnumName",0x9b42910e,"Type.getEnumName","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",62,0x2f1ad73c)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(63)
...
::hx::Class Type_obj::resolveClass( ::String name){
	HX_STACK_FRAME("Type","resolveClass",0x23b06bc0,"Type.resolveClass","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",66,0x2f1ad73c)
...
::Enum Type_obj::resolveEnum( ::String name){
	HX_STACK_FRAME("Type","resolveEnum",0x26394079,"Type.resolveEnum","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",73,0x2f1ad73c)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(74)
	::String tmp = name;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(74)
...
Dynamic Type_obj::createInstance( ::hx::Class cl,cpp::ArrayBase args){
	HX_STACK_FRAME("Type","createInstance",0xab84f9c5,"Type.createInstance","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",80,0x2f1ad73c)
	HX_STACK_ARG(cl,"cl")
...
Dynamic Type_obj::createEmptyInstance( ::hx::Class cl){
	HX_STACK_FRAME("Type","createEmptyInstance",0xcb752312,"Type.createEmptyInstance","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",86,0x2f1ad73c)
	HX_STACK_ARG(cl,"cl")
	HX_STACK_LINE(87)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,cpp::ArrayBase params){
	HX_STACK_FRAME("Type","createEnum",0xd8d56d31,"Type.createEnum","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",90,0x2f1ad73c)
	HX_STACK_ARG(e,"e")
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,cpp::ArrayBase params){
	HX_STACK_FRAME("Type","createEnumIndex",0xd21e2c21,"Type.createEnumIndex","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",94,0x2f1ad73c)
	HX_STACK_ARG(e,"e")
...
Array< ::String > Type_obj::getInstanceFields( ::hx::Class c){
	HX_STACK_FRAME("Type","getInstanceFields",0xe970f890,"Type.getInstanceFields","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",101,0x2f1ad73c)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(101)
...
Array< ::String > Type_obj::getClassFields( ::hx::Class c){
	HX_STACK_FRAME("Type","getClassFields",0x7edf22ef,"Type.getClassFields","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",105,0x2f1ad73c)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(105)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	HX_STACK_FRAME("Type","getEnumConstructs",0x7f46cf7f,"Type.getEnumConstructs","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",109,0x2f1ad73c)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(109)
...
::ValueType Type_obj::_typeof( Dynamic v){
	HX_STACK_FRAME("Type","typeof",0xd6c51d65,"Type.typeof","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",112,0x2f1ad73c)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(113)
...
bool Type_obj::enumEq( Dynamic a,Dynamic b){
	HX_STACK_FRAME("Type","enumEq",0x855650e1,"Type.enumEq","E:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",128,0x2f1ad73c)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(129)
