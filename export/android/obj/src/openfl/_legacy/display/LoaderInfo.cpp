...
Void LoaderInfo_obj::load( ::openfl::_legacy::net::URLRequest request){
{
		...
		if (  ( _switch_1==HX_HCSTRING("swf","\x42","\xab","\x57","\x00"))){
			...
			HX_STACK_LINE(84)
			::String tmp8 = this->__pendingURL;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(84)
			::String tmp9 = (HX_HCSTRING("Unrecognized file ","\x93","\xc5","\xa4","\x36") + tmp8);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(84)
...
::openfl::_legacy::utils::ByteArray LoaderInfo_obj::get_bytes( ){
	HX_STACK_FRAME("openfl._legacy.display.LoaderInfo","get_bytes",0x13e243e5,"openfl._legacy.display.LoaderInfo.get_bytes","openfl/_legacy/display/LoaderInfo.hx",117,0xb6d254aa)
	HX_STACK_THIS(this)
	HX_STACK_LINE(119)
