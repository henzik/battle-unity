...
Void Stage_obj::__onJoystick( Dynamic event,::String type){
{
		...
		if (  ( _switch_1==HX_HCSTRING("axisMove","\x52","\x90","\xf4","\x8f"))){
			...
			HX_STACK_LINE(815)
			::openfl::events::JoystickEvent tmp3 = ::openfl::events::JoystickEvent_obj::__new(type,false,false,event->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic ),event->__Field(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41"), hx::paccDynamic ),null(),null(),null());		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(815)
			joystickEvent = tmp3;
		}
;
		...
		if ((tmp2)){
			...
			if ((tmp9)){
				...
				if ((tmp12)){
					...
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","openfl/_legacy/display/Stage.hx",1148,0x8b30a073)
						{
							HX_STACK_LINE(1150)
...
int Stage_obj::get_color( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_color",0xfd54aa5a,"openfl._legacy.display.Stage.get_color","openfl/_legacy/display/Stage.hx",1269,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1271)
...
int Stage_obj::set_color( int value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_color",0xe0a59666,"openfl._legacy.display.Stage.set_color","openfl/_legacy/display/Stage.hx",1276,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1278)
...
Float Stage_obj::get_dpiScale( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_dpiScale",0xafcc2556,"openfl._legacy.display.Stage.get_dpiScale","openfl/_legacy/display/Stage.hx",1299,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1301)
	Dynamic tmp = this->__handle;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(1301)
...
bool Stage_obj::get_isOpenGL( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_isOpenGL",0x993c5f62,"openfl._legacy.display.Stage.get_isOpenGL","openfl/_legacy/display/Stage.hx",1342,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1344)
	Dynamic tmp = this->__handle;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(1344)
