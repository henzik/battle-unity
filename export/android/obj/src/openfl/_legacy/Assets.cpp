...
Void Assets_obj::loadLibrary( ::String name,Dynamic handler){
{
		...
		if ((tmp4)){
			...
			HX_STACK_LINE(882)
			Dynamic tmp7 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),882,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadLibrary","\x75","\xe5","\x0d","\x10"));		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(882)
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		if ((tmp11)){
			...
			if ((tmp13)){
				...
				::String tmp15 = (tmp14 + HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(937)
				Dynamic tmp16 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),937,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadMusic","\x9f","\x1c","\x92","\x2b"));		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(937)
				::haxe::Log_obj::trace(tmp15,tmp16);
			}
		}
			...
			::String tmp13 = (tmp12 + HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(943)
			Dynamic tmp14 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),943,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadMusic","\x9f","\x1c","\x92","\x2b"));		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(943)
			::haxe::Log_obj::trace(tmp13,tmp14);
		}
		HX_STACK_LINE(949)
...
Void Assets_obj::loadMovieClip( ::String id,Dynamic handler){
{
		...
		if ((tmp7)){
			...
			if ((tmp9)){
				...
				::String tmp11 = (tmp10 + HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(973)
				Dynamic tmp12 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),973,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadMovieClip","\x9a","\xd3","\x80","\x9a"));		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(973)
				::haxe::Log_obj::trace(tmp11,tmp12);
			}
		}
			...
			::String tmp9 = (tmp8 + HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(979)
			Dynamic tmp10 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),979,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadMovieClip","\x9a","\xd3","\x80","\x9a"));		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(979)
			::haxe::Log_obj::trace(tmp9,tmp10);
		}
		HX_STACK_LINE(985)
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		if ((tmp11)){
			...
			if ((tmp13)){
				...
				::String tmp15 = (tmp14 + HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(1036)
				Dynamic tmp16 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),1036,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadSound","\xc9","\xd8","\x03","\x9c"));		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(1036)
				::haxe::Log_obj::trace(tmp15,tmp16);
			}
		}
			...
			::String tmp13 = (tmp12 + HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(1042)
			Dynamic tmp14 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),1042,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadSound","\xc9","\xd8","\x03","\x9c"));		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(1042)
			::haxe::Log_obj::trace(tmp13,tmp14);
		}
		HX_STACK_LINE(1048)
...
Void Assets_obj::loadText( ::String id,Dynamic handler){
{
		...
		if ((tmp7)){
			...
			if ((tmp9)){
				...
				::String tmp11 = (tmp10 + HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(1072)
				Dynamic tmp12 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),1072,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadText","\xf3","\x9d","\x99","\xbd"));		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(1072)
				::haxe::Log_obj::trace(tmp11,tmp12);
			}
		}
			...
			::String tmp9 = (tmp8 + HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(1078)
			Dynamic tmp10 = hx::SourceInfo(HX_HCSTRING("Assets.hx","\xfb","\xcd","\xc6","\x67"),1078,HX_HCSTRING("openfl._legacy.Assets","\x87","\x27","\x89","\x1c"),HX_HCSTRING("loadText","\xf3","\x9d","\x99","\xbd"));		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(1078)
			::haxe::Log_obj::trace(tmp9,tmp10);
		}
		HX_STACK_LINE(1084)
...
::hx::Class Assets_obj::resolveClass( ::String name){
	HX_STACK_FRAME("openfl._legacy.Assets","resolveClass",0x1c65baf3,"openfl._legacy.Assets.resolveClass","openfl/_legacy/Assets.hx",1117,0x9276b055)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(1119)
...
{
		HX_STACK_FRAME("openfl._legacy.Assets","library_onEvent",0x9a352310,"openfl._legacy.Assets.library_onEvent","openfl/_legacy/Assets.hx",1172,0x9276b055)
		HX_STACK_ARG(library,"library")
		HX_STACK_ARG(type,"type")
		HX_STACK_LINE(1174)
