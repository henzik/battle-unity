...
{
HX_STACK_FRAME("StringBuf","new",0xaaa8f4b4,"StringBuf.new","E:\\HaxeToolkit\\haxe\\std/cpp/_std/StringBuf.hx",30,0xbe18f724)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("StringBuf","add",0xaa9f1675,"StringBuf.add","E:\\HaxeToolkit\\haxe\\std/cpp/_std/StringBuf.hx",40,0xbe18f724)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(41)
