...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","E:\\HaxeToolkit\\haxe\\std/StringTools.hx",36,0x60d65beb)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(44)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","E:\\HaxeToolkit\\haxe\\std/StringTools.hx",61,0x60d65beb)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(69)
...
bool StringTools_obj::endsWith( ::String s,::String end){
	HX_STACK_FRAME("StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","E:\\HaxeToolkit\\haxe\\std/StringTools.hx",153,0x60d65beb)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_FRAME("StringTools","isSpace",0xe0290778,"StringTools.isSpace","E:\\HaxeToolkit\\haxe\\std/StringTools.hx",183,0x60d65beb)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_FRAME("StringTools","ltrim",0x24d2234a,"StringTools.ltrim","E:\\HaxeToolkit\\haxe\\std/StringTools.hx",200,0x60d65beb)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(204)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_FRAME("StringTools","rtrim",0x99399e50,"StringTools.rtrim","E:\\HaxeToolkit\\haxe\\std/StringTools.hx",225,0x60d65beb)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(229)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(230)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_FRAME("StringTools","trim",0x2908d066,"StringTools.trim","E:\\HaxeToolkit\\haxe\\std/StringTools.hx",247,0x60d65beb)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(253)
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_FRAME("StringTools","replace",0x6d651f30,"StringTools.replace","E:\\HaxeToolkit\\haxe\\std/StringTools.hx",312,0x60d65beb)
	HX_STACK_ARG(s,"s")
